...
import com.example.myapplication.Adapter.AdapterStepsTwoPane;
...
public class FetchDataDetailsTwoPane extends AsyncTask<Void, Void, List<BakingRecipe>> {


    public FetchDataDetailsTwoPane(int data) {
        this.id = data;
    }
    int id;
    public FetchDataDetailsTwoPane(Context context, int data) {
        this.id = data;
...
//            for (int i = 0; i < json.length(); i++) {
            ...
            adapterSteps=new AdapterStepsTwoPane(stepsList)
;
